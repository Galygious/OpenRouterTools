...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const OPENROUTER_API = {
    ...
    MODELS_ENDPOINT: '/frontend/stats/models'
  };
  ...
  async function fetchWithAuth(url, options = {}) {
    ...
    // Only add Authorization header if we have an API key and the URL requires it
    if (apiKeyValue && !url.includes('/models') && !url.includes('/frontend/stats')) {
  ...
  // Initialize model data when page loads
  fetchModelData();
});
