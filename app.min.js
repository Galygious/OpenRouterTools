...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function populateCreatorDropdown() {
    console.log('Model Data for Creators:', modelData); // Debug log
  ...
  function handleCreatorSelection() {
    ...
    console.log('Selected Creator:', selectedCreator); // Debug log
    ...
    console.log('Creator Models:', creatorModels); // Debug log
    const uniqueModels = [...new Set(creatorModels.map(model => model.name))].filter(Boolean);
  ...
  function handleModelSelection() {
    ...
    console.log('Model Versions:', modelVersions); // Debug log
    const uniqueVersions = [...new Set(modelVersions.map(model => model.version))].filter(Boolean);
  ...
  function handleVersionSelection() {
    ...
    const selectedModel = modelDropdown.val();
    const selectedCreator = creatorDropdown.val();
    console.log('Selected Version:', selectedVersion); // Debug log
    ...
    console.log('Configurations:', configurations); // Debug log
